...
#+INCLUDE: "../../org-templates/blog-header.org"
#+HTML_HEAD: <link rel="stylesheet" href="../../styles/org.css"/>
#+HTML_HEAD_EXTRA: <link rel="stylesheet" href="../../styles/sidebar.css"/>
#+HTML_HEAD_EXTRA: <link rel="stylesheet" href="test.css"/>
#+INCLUDE: "../../org-templates/sidebar.org"
...
Things to Remember:
 ...
 - Take a screenshot of the site befor and after applying the settings
...
* The Plan
The easiest way to organize the project would most likeyly be through
two files: an emacs library to hold the exporter code and a publishing
script that will handle updateing the web server with the appropreate
files.
